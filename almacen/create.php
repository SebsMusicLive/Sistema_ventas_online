                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="codigo" id=""value="<?php echo 'P-' . ceros($contador_de_id_productos); ?>" hidden = "hidden">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="id_categoria" id="" class="form-control" required = "required">
                                                            ...
                                                            <a href="<?php echo $URL;?>/categorias/" class = "btn btn-primary"><i class="fa fa-plus"></i></a></div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="id_usuario" value="<?php echo $id_usuario_sesion;?>" hidden = "hidden">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-8">
                                                        <div class="form-group">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name='precio_compra' class="form-control" required = "required">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            <label for="">Precio de venta:</label>
                                                            <input type="number" name='precio_venta' class="form-control" required = "required">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            <label for="">Fecha de ingreso:</label>
                                                            <input type="date" name="fecha_ingreso" class="form-control" required = "required">
                                                        </div>
                                                    </div>
                                                </div>
